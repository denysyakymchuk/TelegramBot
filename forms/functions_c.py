...
class Functions:
    ...
    async def send_currency(self, message):
        keyboard = send_paginated_buttons(page=1, number_cell=1, button_list_domestic=self.buttons)
    ...
    async def send_currency_to(self, message):
        keyboard = send_paginated_buttons(page=1, number_cell=3, button_list_domestic=self.buttons)
        print(keyboard)
