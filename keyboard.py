...
h_curr_usd_g = KeyboardButton(text='USD Наличними')
h_curr_usd_ng = KeyboardButton(text='USD Безналичними')
...
beznaja = KeyboardButton(text='Безналичние')
...
view_money = ReplyKeyboardMarkup(resize_keyboard=True).add(gotowka,beznaja,rachnunek,another_view,cancel_view)
